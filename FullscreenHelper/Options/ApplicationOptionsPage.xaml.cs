...
namespace FullscreenHelper.Options {
	/// <summary>
	...
	public partial class ApplicationOptionsPage : Page {
		...
		public ApplicationOptionsPage() {
			...
			// 第一项为系统默认语言
			_ = cbbLanguage.Items.Add(FullscreenHelper.Properties.Resources.UI_Options_Application_Language_Default);
			...
			pathLink = startUpFolder + "\\FullscreenHelper.lnk";
		...
		private void CbbLanguage_SelectionChanged(object sender, SelectionChangedEventArgs e) {
			...
			if (Settings.Default.CultureName != originCulture) {
				...
				// 提示信息的语言为将要切换的语言
				lblRestartToApply1.Content = FullscreenHelper.Properties.Resources.ResourceManager.GetString(
