...
namespace FullscreenHelper.Options {
	...
	public partial class ScaleOptionsPage : Page {
		...
		public ScaleOptionsPage() {
			...
			// 图形适配器
			cbbAdapter.Items.Add(FullscreenHelper.Properties.Resources.UI_Options_Scale_Adapter_Default);
			...
			_ = cbbCursorZoomFactor.Items.Add(new ComboBoxItem {
				Content = FullscreenHelper.Properties.Resources.UI_Options_Scale_Cursor_Same_As_Source_Window
			});
