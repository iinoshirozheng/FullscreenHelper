...
1. Visual Studio 2022
	1. .NET 桌面開發
	1. 使用 C++ 的桌面開發
	1. Windows SDK build 22000 或更高版本
1. [Windows x64 Installer](https://cmake.org/download/)
1. [Conan x86_64 installer](https://conan.io/downloads.html)
1. Rebuid Project: `CONAN_INSTALL`
1. Rebuid Project: `FullscreenHelper`
